...
let musicSqlMap = {
  ...
  musics: {
    ...
    //获得所有音乐
    all: 'select a.music_name,a.singer,b.album_name from music a, album b where a.album_id = b.id limit ?,?',
    //获得对应类型的音乐
    type: 'select a.music_name,a.singer,b.album_name from music a, album b where a.type_id = (select id from type ' +
